...
export default function CustomerOrderDetailPage() {
  ...
  const handleCancelOrder = async () => {
    if (!confirm('Are you sure you want to cancel this entire order? Restocked inventory will be returned to merchants.')) {
      return;
    }
        ...
        <div className="flex items-center justify-between border-b border-(--border-dark) pb-4">
          ...
          {isCancellable && (
            ...
            >
              ...
              <span>{cancelling ? 'Cancelling Order...' : 'Cancel Full Order'}</span>
            </button>
          )}
        </div>
