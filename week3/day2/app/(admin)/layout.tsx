    ...
    return (
      <div className="min-h-screen flex flex-col bg-[var(--bg-canvas)] text-[var(--text-on-dark)] transition-colors duration-200">
        ...
        <div className="max-w-md mx-auto py-24 px-4 text-center space-y-4">
          ...
          <h1 className="text-xl font-bold text-[var(--text-on-dark)]">Access Denied (403)</h1>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[var(--bg-canvas)] text-[var(--text-on-dark)] transition-colors duration-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full flex-1 space-y-6">
        {/* Admin Header Strip */}
        <div className="p-5 rounded-2xl bg-[var(--surface-card)] border border-[var(--border-dark)] flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-base font-bold text-[var(--text-on-dark)] tracking-tight">Marketplace Administration</h1>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <Link
              ...
              className="px-3 py-1.5 rounded-lg bg-[var(--surface-card-subtle)] hover:bg-[var(--border-dark)] text-[var(--text-on-dark)] border border-[var(--border-dark)] text-xs font-semibold flex items-center gap-1.5 transition-colors"
            >
