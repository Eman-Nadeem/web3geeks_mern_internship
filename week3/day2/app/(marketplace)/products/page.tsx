...
export default async function ProductsPage({ searchParams }: ProductsPageProps) {
  ...
  return (
    <div className="w-full bg-[var(--bg-canvas)] text-[var(--text-on-dark)] py-10 min-h-[85vh] transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        {/* Header */}
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-[var(--border-dark)] pb-6">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-[var(--text-on-dark)] tracking-tight">
              Marketplace Catalog
            </h1>
            <p className="text-[14px] text-[var(--text-on-dark-muted)] mt-1">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-2 no-scrollbar">
            <span className="text-xs text-[var(--text-on-dark-muted)] flex items-center gap-1 mr-2 shrink-0">
