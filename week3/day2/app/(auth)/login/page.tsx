  ...
  return (
    <div className="w-full flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-md text-center space-y-2 mb-6">
        ...
        <p className="text-[13px] text-[var(--text-on-dark-muted)]">Welcome back to Nexus Market</p>
      </div>
      ...
      <div className="w-full max-w-md bg-[var(--surface-card)] rounded-2xl border border-[var(--border-dark)] shadow-xl p-6 sm:p-8 text-[var(--text-on-dark)]">
        ...
        <div className="mb-5 pb-4 border-b border-[var(--border-dark)]">
          <span className="text-[11px] font-semibold text-[var(--text-on-dark-muted)] uppercase tracking-wider block mb-2">
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className="py-1.5 px-2 rounded-lg bg-[var(--surface-card-subtle)] hover:bg-[var(--border-dark)] border border-[var(--border-dark)] text-[12px] font-semibold text-[var(--text-on-dark)] flex items-center justify-center gap-1 transition-colors cursor-pointer"
            >
