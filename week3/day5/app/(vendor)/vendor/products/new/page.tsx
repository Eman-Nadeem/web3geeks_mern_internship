...
export default function NewProductPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div>
        <h2 className="text-2xl font-bold text-(--text-on-dark) tracking-tight">Add New Product</h2>
      ...
      <form onSubmit={handleSubmit} className="p-8 rounded-3xl bg-(--surface-card) border border-(--border-dark) space-y-6 shadow-sm">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-(--text-on-dark)">Product Name *</label>
            <input
              type="text"
              required
              value={name}
              ...
              className="w-full px-3.5 py-2 bg-(--surface-card-subtle) border border-(--border-dark) rounded-xl text-xs text-(--text-on-dark) placeholder:text-(--text-on-dark-muted) focus:outline-none focus:border-emerald-500"
            />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-(--text-on-dark)">Product SKU (Unique to your store) *</label>
              <input
                type="text"
                required
                value={sku}
                ...
                className="w-full px-3.5 py-2 bg-(--surface-card-subtle) border border-(--border-dark) rounded-xl text-xs text-(--text-on-dark) font-mono placeholder:text-(--text-on-dark-muted) focus:outline-none focus:border-emerald-500"
              />
              {fieldErrors.sku && <p className="text-[11px] text-rose-500">{fieldErrors.sku[0]}</p>}
            </div>

            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-(--text-on-dark)">Product Slug (Public URL) *</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 bg-(--surface-card-subtle) border border-(--border-dark) rounded-xl text-xs text-emerald-600 dark:text-emerald-400 font-mono placeholder:text-(--text-on-dark-muted) focus:outline-none focus:border-emerald-500"
                />
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-(--text-on-dark)">Category *</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 bg-(--surface-card-subtle) border border-(--border-dark) rounded-xl text-xs text-(--text-on-dark) placeholder:text-(--text-on-dark-muted) focus:outline-none focus:border-emerald-500"
                />
              </div>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-(--text-on-dark)">Publication Status</label>
              <select
                value={status}
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-(--text-on-dark)">Description *</label>
            <textarea
              rows={4}
              required
              value={description}
              ...
              className="w-full p-3 bg-(--surface-card-subtle) border border-(--border-dark) rounded-xl text-xs text-(--text-on-dark) placeholder:text-(--text-on-dark-muted) focus:outline-none focus:border-emerald-500"
            />
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-(--text-on-dark)">Selling Price ($ USD) *</label>
              <div className="relative">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-(--text-on-dark)">Compare-at Price ($ USD) - Optional</label>
              <div className="relative">
                <DollarSign className="w-4 h-4 text-(--text-on-dark-muted) absolute left-3 top-1/2 -translate-y-1/2" />
                <input
                  type="number"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-(--text-on-dark)">Initial Stock Units *</label>
              <div className="relative">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-(--text-on-dark)">Low-Stock Alert Threshold *</label>
              <input
                type="number"
                min="0"
                required
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
              <div className="sm:col-span-8 flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-2 bg-(--surface-card-subtle) hover:bg-(--border-dark) text-(--text-on-dark) border border-(--border-dark) rounded-xl text-xs font-semibold shrink-0 cursor-pointer"
                >
                  Add URL
                </button>
              </div>
            ...
            {images.length > 0 && (
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
                {images.map((img, idx) => (
                  ...
                  >
                    <img src={img.url} alt="" className="w-full h-24 object-contain rounded-lg bg-(--surface-card)" />
                    <div className="flex items-center justify-between w-full text-xs pt-1 border-t border-(--border-dark)">
                      <button
                        ...
                        className={`flex items-center gap-1 text-[11px] font-semibold cursor-pointer ${
                          img.isPrimary ? 'text-emerald-500 font-bold' : 'text-(--text-on-dark-muted) hover:text-(--text-on-dark)'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className="text-(--text-on-dark-muted) hover:text-rose-500 p-1 cursor-pointer"
                        title="Remove Image"
                      >
        ...
        <div className="space-y-4 pt-2">
          <div className="flex items-center justify-between border-b border-(--border-dark) pb-2">
            ...
            <label className="flex items-center gap-2 text-xs text-(--text-on-dark) cursor-pointer">
              <input
                type="checkbox"
                checked={hasVariants}
          ...
          {hasVariants && (
            <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {variants.length > 1 && (
                      <button
                        ...
                        className="text-(--text-on-dark-muted) hover:text-rose-500 text-xs flex items-center gap-1 cursor-pointer"
                      >
              ...
              <button
                ...
                className="px-3.5 py-2 bg-(--surface-card-subtle) hover:bg-(--border-dark) text-(--text-on-dark) border border-(--border-dark) rounded-xl text-xs font-semibold flex items-center gap-1.5 cursor-pointer"
              >
