...
export default async function VendorStorefrontPage({ params }: VendorStorefrontPageProps) {
  ...
  return (
    <div className="w-full space-y-10 pb-20 bg-(--bg-canvas) text-(--text-on-dark) min-h-[85vh] transition-colors duration-200">
      {/* 1. Hero Banner Pattern */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
        <div className="mb-3">
          <Link
            href="/vendors"
            className="inline-flex items-center gap-1.5 text-xs font-semibold text-(--text-on-dark-muted) hover:text-(--text-on-dark) transition-colors"
          >
        ...
        <div className="relative overflow-hidden rounded-2xl bg-linear-to-r from-[#0E2B24] to-[#153229] border border-[#1E4338] min-h-65 flex items-center p-8 sm:p-12 shadow-lg">
