...
export default async function HomePage() {
  ...
  return (
    <div className="w-full bg-(--bg-canvas) text-(--text-on-dark) space-y-10 pb-20 transition-colors duration-200">
      {/* 1. Hero Banner (bg-hero gradient with bleeding product photography) */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
        <div className="relative overflow-hidden rounded-2xl bg-linear-to-r from-[#0E2B24] to-[#153229] border border-[#1E4338] min-h-[300px] sm:min-h-[340px] flex items-center shadow-lg">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-[20px] font-bold text-(--text-on-dark) tracking-tight mb-4">
          Popular Categories
        </h2>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-[20px] font-bold text-(--text-on-dark) tracking-tight">
            Trending Products
          </h2>
          <Link
            href="/products"
            className="text-[13px] text-(--text-on-dark-muted) hover:text-(--text-on-dark) transition-colors"
          >
            See all products →
          </Link>
        </div>
              ...
              >
                <div>
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-lg bg-(--bg-header) text-(--text-on-dark) border border-(--border-dark) flex items-center justify-center font-bold text-sm shrink-0">
