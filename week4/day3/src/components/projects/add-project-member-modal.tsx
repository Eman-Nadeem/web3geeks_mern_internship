      ...
      <div className="space-y-4 mt-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-xl border border-slate-800 bg-slate-950 text-sm text-slate-200 placeholder-slate-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
        </div>

        {/* Member Select List */}
        <div className="max-h-60 overflow-y-auto space-y-1.5 rounded-xl border border-slate-800 p-2 bg-slate-950/50">
          {isLoading ? (
