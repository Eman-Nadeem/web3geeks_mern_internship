  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-2">
        ...
        {isFormerMember && (
          <div className="flex items-start gap-2.5 p-3 rounded-xl bg-amber-950/40 border border-amber-800/60 text-xs text-amber-300">
        ...
        {isConfirmingDelete ? (
          <div className="p-3.5 rounded-xl bg-red-950/40 border border-red-800/80 space-y-3 mt-4">
