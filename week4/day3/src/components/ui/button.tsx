...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseStyles =
      "inline-flex items-center justify-center font-medium rounded-lg transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#0b0f17] disabled:opacity-50 disabled:cursor-not-allowed select-none";
    ...
    const variantStyles = {
      ...
      outline:
        "bg-transparent text-slate-200 border border-slate-700 hover:bg-slate-800 hover:text-white focus:ring-slate-500",
      destructive:
