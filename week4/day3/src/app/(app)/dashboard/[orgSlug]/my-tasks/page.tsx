      ...
      <div className="flex flex-col gap-4 rounded-2xl border border-slate-800 bg-slate-900/40 p-5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="text-xs text-slate-400">
            Showing <span className="font-semibold text-white">{tasks.length}</span> assigned items
          </div>
        </div>
                    ...
                    <tr key={task.id} className="hover:bg-slate-800/40 transition-colors">
                      ...
                      <td className="py-3.5 px-4 whitespace-nowrap">
                        <Link
                          ...
                          className="font-medium text-blue-400 hover:text-blue-300 hover:underline flex items-center gap-1.5"
                        >
