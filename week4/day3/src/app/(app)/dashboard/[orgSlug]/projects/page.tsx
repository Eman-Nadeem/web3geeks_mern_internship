  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                ...
                <span className="text-slate-300 font-medium">{orgDetail?.name || matchingOrg.name}</span>
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-xl border border-slate-800 bg-slate-900/60 text-sm text-slate-200 placeholder-slate-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
        </div>
      ...
      {isProjectsLoading ? (
        ...
        /* Empty State */
        <div className="rounded-2xl border border-slate-800/80 bg-slate-900/30 backdrop-blur-xl p-12 text-center">
          <div className="mx-auto w-14 h-14 rounded-2xl bg-purple-600/10 border border-purple-500/20 text-purple-400 flex items-center justify-center mb-4">
