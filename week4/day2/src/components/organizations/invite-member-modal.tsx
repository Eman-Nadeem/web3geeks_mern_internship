      ...
      {createdInviteLink ? (
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            ...
            <select
              {...register("role")}
              className="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
            >
