...
export function MemberList({ organizationId }: MemberListProps) {
    ...
    return (
      <div className="space-y-3">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="flex items-center justify-between p-3.5 rounded-lg border border-slate-800 bg-slate-900/40"
          >
  ...
  if (error) {
    return (
      <div className="p-4 rounded-lg bg-red-950/20 border border-red-900/40 text-red-300 text-xs">
