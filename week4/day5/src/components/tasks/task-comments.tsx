                    ...
                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      {canDelete && (
                        deletingCommentId === comment.id ? (
                          <div className="flex items-center gap-1 bg-red-50 dark:bg-red-950/40 px-1.5 py-0.5 rounded border border-red-200 dark:border-red-900/50">
                            ...
                            <button
                              ...
                              className="px-1 py-0.5 rounded bg-red-600 text-white hover:bg-red-700 text-[10px] font-semibold leading-none"
                            >
                              Yes
                            </button>
                            <button
                              ...
                              className="px-1 py-0.5 rounded bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-300 text-[10px] leading-none"
                            >
                              No
                            </button>
                          </div>
