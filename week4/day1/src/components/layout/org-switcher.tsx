  ...
  return (
    <div className="flex items-center gap-2 overflow-x-auto py-1">
      ...
      <Link
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium text-slate-400 hover:text-white bg-slate-900/40 hover:bg-slate-800/80 border border-dashed border-slate-700 transition-colors shrink-0"
      >
