...
export class InMemoryPrisma {
  ...
  public projectMember = {
    ...
    deleteMany: async () => {
      const count = this.projectMembers.size;
      this.projectMembers.clear();
      return { count };
    },
  };
  ...
  public activity = {
    ...
    findMany: async () => Array.from(this.activities.values()),
    count: async () => this.activities.size,
  };
  ...
  public notification = {
    ...
    findMany: async () => Array.from(this.notifications.values()),
    ...
    updateMany: async ({ data }: any) => {
      ...
      return { count: this.notifications.size };
    },
  };
