    ...
    <Dialog isOpen={isOpen} onClose={handleClose}>
      ...
      <div className="space-y-4 py-2">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-300">
          ...
          <strong className="text-slate-900 dark:text-white font-semibold">{memberName}</strong> ({memberEmail})
          from the organization?
        </p>

        <div className="p-3 rounded-lg bg-red-50 text-red-800 border border-red-200 dark:bg-red-950/20 dark:border-red-900/40 dark:text-red-300 text-xs flex items-start gap-2">
