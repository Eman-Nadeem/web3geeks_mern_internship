  ...
  return (
    ...
    >
      <form onSubmit={handleDelete} className="space-y-4">
        ...
        <div className="rounded-lg bg-red-50 text-red-800 border border-red-200 dark:bg-red-950/20 dark:border-red-900/50 dark:text-red-300 p-3.5 text-xs flex items-start gap-2.5">
        ...
        <div>
          <label className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-1.5">
            Type <span className="text-slate-900 dark:text-white font-mono bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded border border-slate-300 dark:border-slate-700">{organizationName}</span> to confirm:
          </label>
          <Input
            value={confirmText}
