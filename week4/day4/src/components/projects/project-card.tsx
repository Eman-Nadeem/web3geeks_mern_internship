...
export function ProjectCard({ project, orgSlug }: ProjectCardProps) {
  ...
  return (
    <Link
      ...
      className="group block relative rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/40 p-6 backdrop-blur-xl transition-all duration-200 hover:border-blue-500/40 hover:bg-slate-50 dark:hover:bg-slate-900/70 shadow-sm dark:shadow-none hover:shadow-md dark:hover:shadow-xl hover:shadow-blue-500/5"
    >
      ...
      <p className="text-xs text-slate-500 dark:text-slate-400 line-clamp-2 min-h-[32px] mb-5">
      ...
      <div className="space-y-1.5 mb-5">
        <div className="flex items-center justify-between text-xs">
          ...
          <span className="font-semibold text-slate-800 dark:text-slate-200">{completion}%</span>
        </div>
      ...
      {/* Footer Info */}
      <div className="flex items-center justify-between pt-4 border-t border-slate-200 dark:border-slate-800/70 text-xs text-slate-500 dark:text-slate-400">
        {/* Owner */}
