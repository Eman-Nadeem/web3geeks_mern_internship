    ...
    <>
      ...
      <div className="lg:hidden flex items-center justify-between px-4 py-3 bg-(--bg-surface) border-b border-(--border-subtle) sticky top-0 z-40 w-full">
        ...
        <button
          ...
          className="p-2 text-(--text-secondary) hover:text-(--text-primary) rounded-lg bg-(--bg-canvas) min-h-[44px] min-w-[44px] flex items-center justify-center transition-colors"
      ...
      >
        ...
        {/* Sidebar Footer with Presence Status */}
        <div className="p-3 border-t border-(--border-subtle) bg-(--bg-surface-muted) flex items-center justify-between text-xs shrink-0">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className="text-[12px] font-medium text-(--text-primary)">Demo Architect</span>
              <span className="text-[10px] text-(--status-success) flex items-center gap-1 font-medium">
                Online
              </span>
            </div>
          </div>
          <span className="text-[11px] text-(--text-tertiary) font-mono">v1.0</span>
        </div>
      </aside>
